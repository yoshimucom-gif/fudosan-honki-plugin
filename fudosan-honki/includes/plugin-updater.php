<?php
/**
 * 不動産 訪問査定申込（本気査定） — プラグイン自動更新チェッカー
 *
 ...
 *   - fudosan-honki.zip  … 配布本体
 */

if (!defined('ABSPATH')) exit;

if (!class_exists('FHS_Honki_Updater')) :

class FHS_Honki_Updater {
    private $plugin_file;
    private $plugin_slug;
    ...
    public function __construct($plugin_file, $update_url, $cache_ttl = 1800) {
        ...
        $this->cache_key       = 'fhs_honki_updater_' . md5($this->plugin_basename);
